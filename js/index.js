...
if (person!= null ) {
  ...
  if(person =="Enter your name first" || person == null)
 {
    document.getElementById('userBox').innerHTML = "Welcome to SnakeKing Bot";
...
function main(ctime) {
    ...
    // console.log(ctime)
    if((ctime - lastPaintTime)/1000 < 1/speed){ //checking frame rate speed
        return;
    }
    lastPaintTime = ctime;
    musicSound.play();
